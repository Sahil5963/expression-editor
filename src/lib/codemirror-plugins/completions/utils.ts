import { HTTP_REQUEST_NODE_TYPE, SPLIT_IN_BATCHES_NODE_TYPE } from '@/lib/constants';
import { CREDENTIAL_EDIT_MODAL_KEY } from '@/lib/credentials-constants';
import { useWorkflowsStore, useNDVStore } from '@/lib/stores';
import { resolveParameter, useUIStore } from '@/lib/stubs';
import {
...
import { escapeMappingString } from '@/lib/utils';

// Mock type for TargetNodeParameterContext
interface TargetNodeParameterContext {
	nodeName: string;
