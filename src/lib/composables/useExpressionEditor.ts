...
import type { IDataObject } from '@/types/n8n-workflow';
import { Expression, ExpressionExtensions } from '@/types/n8n-workflow';

import {
	EXPRESSION_EDITOR_PARSER_TIMEOUT,
	ExpressionLocalResolveContextSymbol,
} from '@/lib/constants';
import { useNDVStore } from '@/lib/stores';
...
import { isEventTargetContainedBy } from '@/lib/utils';
